if (typeof window.bibleData === 'undefined') { window.bibleData = {}; } window.bibleData['3jo'] = {
  "book": "3jo",
  "name": "3 João",
  "chapters": [
    {
      ...
      "verses": [
        ...
        {
          "verse": 6,
          "text": "Os quais em presença da igreja testificaram do teu amor; aos quais, se conduzires como é digno para com Deus, bem farás;"
        },
        {
          "verse": 7,
        ...
        {
          "verse": 11,
          "text": "Amado, não sigas o que é mal, mas o que é bom. Quem faz o bem é de Deus; mas quem faz o mal não tem visto a Deus."
        },
        {
          "verse": 12,
